...
│   │   ├── 2.1_ml_pipeline_clustering.ipynb       ← K-Means + GBT attack pattern clustering
│   │   └── 3.0_url_triage_demo.ipynb              ← combined SVM + K-Means + GBT triage tool
│   ├── pdfs/
...
- **[Notebook 2.1 — K-Means + GBT Clustering](Project/notebooks/2.1_ml_pipeline_clustering.ipynb)**
