...
%\item The problem addressed
Now that we've started getting the foundations of this research topic laid, this new paper from Sonowal and Gunikhan's shows how breadth of study for semantic spam blocking entails so much more than just emails.
...
Despite advancements in defensive systems like firewalls and email filtering, "naïve information security practices" as the authors put it accounts for for between 72\% and 95\% of all cyber threats \cite{dash1}.
