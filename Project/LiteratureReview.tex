...
To begin, we start with our oldest paper from 2016, as this paper shows the limitations of the research into spam indicators before the usage of modern ML techniques like large Language models.
...
With the effect of spam and phishing fully realized in the previous papers, there should be no surprise that a continued effort exists for preventing attacks from successfully landing.
Training is a key part of this, and in a way, can be seen as teaching humans the ways to spot the indicators ML saw earlier.
We saw many advancements in preventing spam in the first place, but for the false negatives, authors TODO and TODO show how reactive defense should be expanded.
This moves us into the year 2022, and here, 
