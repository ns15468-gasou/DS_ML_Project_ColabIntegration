...
And speaking of that data, two data sources were chosen by our team. For IoCs, the Phishtank Verified dataset was chosen, as it had a reasonable amount of training data with 50k+ Phishing URLs verified as malicious by Cisco Talos \cite{phishtank}.
...
\node[block, below=1.4cm of CLEAN] (API) {\textbf{Gemini Embedding API}\\(batches of 200)};
