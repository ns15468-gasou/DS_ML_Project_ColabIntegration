...
Describe datasets (sources, size, features, time range). Discuss data collection, cleaning, and
preprocessing steps. Address ethical considerations (privacy, consent, bias).
2
...
Describe train-test split, cross-validation, and hyperparameter tuning. Specify software,
libraries, hardware, an
