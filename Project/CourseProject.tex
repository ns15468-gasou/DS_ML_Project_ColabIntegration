...
K-Means clustering analysis was performed on all data points labeled as ``Other'' in the PhishTank dataset; these account for approximately 90\% of all \textasciitilde56,000 data points (Figure \ref{fig:clust}). Four groups were chosen based on the highest number of clusters that still introduced minimal noise. As seen in the elbow curve, a case can be made for \texttt{k=3}, as two clusters show conceptual similarities; however, their feature profiles are distinct enough to warrant separation.
